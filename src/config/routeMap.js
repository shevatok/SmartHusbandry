...
const Petugas = Loadable({
  loader: () => import(/*webpackChunkName:'Petugas'*/ '@/views/petugas'),
  loading: Loading,
})
const Peternak = Loadable({
  loader: () => import(/*webpackChunkName:'Peternak'*/ '@/views/peternak'),
  loading: Loading,
})
...
const Vaksin = Loadable({
  loader: () => import(/*webpackChunkName:'Vaksin'*/ '@/views/vaksin'),
  loading: Loading,
})
...
const rumpunhewan = Loadable({
  loader: () => import(/*webpackChunkName:'Pkb'*/ '@/views/rumpun-hewan'),
  loading: Loading,
})
