...
class EditPetugasForm extends Component {
  render() {
    ...
    const { nikPetugas, namaPetugas, noTelp, email, wilayah } = currentRowData
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Form.Item label="Wilayah Petugas">
            {getFieldDecorator('wilayah', {
              initialValue: wilayah,
            })(<Input placeholder="Masukkan Wilayah Petugas!" />)}
          </Form.Item>
        </Form>
      </Modal>
    )
