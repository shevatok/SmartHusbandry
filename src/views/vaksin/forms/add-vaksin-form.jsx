        ...
        >
          <Form.Item label="Nama Vaksin:">
            {getFieldDecorator('namaVaksin', {
              rules: [
                {
                  required: true,
                  message: 'Silahkan isi nama vaksin buatan',
                },
              ],
          ...
          <Form.Item label="Jenis Vaksin:">
            {getFieldDecorator('jenisVaksin', {
              rules: [
                {
                  required: true,
                  message: 'Silahkan isi jenis vaksin buatan',
                },
              ],
          ...
          <Form.Item label="Eartag Hewan:">
            {getFieldDecorator('hewan_id', {
              rules: [{ required: true, message: 'Silahkan isi Eartag Hewan' }],
            })(
...
export default Form.create({ name: 'AddVaksinForm' })(AddVaksinForm)
